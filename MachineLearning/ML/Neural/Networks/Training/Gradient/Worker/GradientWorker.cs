...
using MachineLearning.ML.Neural.Networks.Training.Propagation;
using MachineLearning.ML.Utils.ActivationFunctions;
using MachineLearning.ML.Utils.Array;
using MachineLearning.ML.Utils.ErrorCalculation;
...
namespace MachineLearning.ML.Neural.Networks.Training.Gradient.Worker
{
